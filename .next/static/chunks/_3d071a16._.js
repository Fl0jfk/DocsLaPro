...
function GoogleAgenda() {
    ...
    function hasAccess() {
        ...
        const rolesRaw = (_user_publicMetadata = user.publicMetadata) === null || _user_publicMetadata === void 0 ? void 0 : _user_publicMetadata.role;
        let roles = [];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GoogleAgenda.useEffect": ()=>{
            if (!hasAccess()) return; // pas d'accès
            async function fetchTokens() {
                try {
                    const res = await fetch("/api/google/gettokens");
                    if (!res.ok) return;
                    const data = await res.json();
                    const email = Object.keys(data)[0]; // pour tester avec le premier utilisateur
            ...
            async function fetchCalendars() {
                try {
                    ...
                    if (data.items && data.items.length > 0) {
                        setSelectedCalendar(data.items[0].id); // agenda principal par défaut
                    }
                } catch (err) {
    ...
    // 3️⃣ Récupération des événements pour le calendrier sélectionné
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GoogleAgenda.useEffect": ()=>{
            ...
            async function fetchEvents() {
                try {
                    ...
                    const res = await fetch("https://www.googleapis.com/calendar/v3/calendars/".concat(encodeURIComponent(selectedCalendar), "/events?timeMin=").concat(now, "&maxResults=50&orderBy=startTime&singleEvents=true"), {
                        headers: {
                            Authorization: "Bearer ".concat(tokens.accessToken)
                        }
                    });
    ...
    // 4️⃣ Génération du calendrier à la main
    function renderCalendar() {
        const today = new Date();
        const startOfWeek = new Date(today);
        startOfWeek.setDate(today.getDate() - today.getDay()); // dimanche de la semaine
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "jsx-d4fd3eb91562ea56" + " " + "calendar",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "jsx-d4fd3eb91562ea56" + " " + "calendar-header",
                    children: days.map((day)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "jsx-d4fd3eb91562ea56" + " " + "calendar-day-header",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "jsx-d4fd3eb91562ea56" + " " + "calendar-body",
                    children: days.map((day)=>{
                        const dayEvents = events.filter((evt)=>{
                            const eventDate = evt.start.dateTime || evt.start.date;
                            return new Date(eventDate).toDateString() === day.toDateString();
                        });
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "jsx-d4fd3eb91562ea56" + " " + "calendar-day",
                            children: dayEvents.map((evt)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "jsx-d4fd3eb91562ea56" + " " + "calendar-event",
                                    children: [
                                        evt.start.dateTime ? new Date(evt.start.dateTime).toLocaleTimeString([], {
                                            hour: '2-digit',
                                            minute: '2-digit'
                                        }) : "All Day",
                                        " - ",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    id: "d4fd3eb91562ea56",
                    children: ".calendar.jsx-d4fd3eb91562ea56{flex-direction:column;gap:1rem;display:flex}.calendar-header.jsx-d4fd3eb91562ea56{display:flex}.calendar-day-header.jsx-d4fd3eb91562ea56{text-align:center;flex:1;font-weight:700}.calendar-body.jsx-d4fd3eb91562ea56{display:flex}.calendar-day.jsx-d4fd3eb91562ea56{border:1px solid #ccc;flex:1;min-height:150px;padding:4px}.calendar-event.jsx-d4fd3eb91562ea56{background:#f0f8ff;border-radius:4px;margin:2px 0;padding:2px 4px;font-size:.9rem}"
    ...
    // Si utilisateur sans rôle autorisé, ne rien afficher
    if (!hasAccess()) return null;
    // Si pas de tokens, afficher bouton connexion
    if (!tokens) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
            href: "/api/google",
            className: "btn",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            calendars.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                        children: "Choisir un calendrier : "
                    }, void 0, false, {
                        fileName: "[project]/app/components/GoogleAgenda/GoogleAgenda.tsx",
                        lineNumber: 167,
                        columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                        ...
                        children: calendars.map((cal)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                value: cal.id,
                                children: [
                                    cal.summary,
                                    " (",
            ...
            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: "Aucun événement à afficher."
            }, void 0, false, {
                fileName: "[project]/app/components/GoogleAgenda/GoogleAgenda.tsx",
                lineNumber: 182,
                columnNumber: 31
...
_s(GoogleAgenda, "FE9NliQBUI6wPKm/bC/M8lq9pRk=", false, function() {
    return [
...
//# sourceMappingURL=_3d071a16._.js.map