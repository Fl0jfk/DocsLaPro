...
function ProfRoomPage() {
    ...
    var _user_lastName;
    const lastName = ((_user_lastName = user === null || user === void 0 ? void 0 : user.lastName) !== null && _user_lastName !== void 0 ? _user_lastName : "").toUpperCase();
    ...
    async function handleConfirm() {
        ...
        const start = new Date("".concat(selectedDate, "T").concat(selectedHour.toString().padStart(2, "0"), ":30"));
        ...
        const res = await fetch("/api/reservation-rooms/reservations/create", {
            ...
            body: JSON.stringify({
                ...
                firstName: firstName,
                lastName: lastName,
                email: user === null || user === void 0 ? void 0 : (_user_primaryEmailAddress = user.primaryEmailAddress) === null || _user_primaryEmailAddress === void 0 ? void 0 : _user_primaryEmailAddress.emailAddress
            })
        });
        if (res.ok) {
    ...
    async function handleDeleteReservation(reservation) {
        const reason = prompt("Motif de l'annulation pour ".concat(reservation.firstName, " ").concat(reservation.lastName, " :"), "Indisponibilité exceptionnelle de la salle");
        ...
        children: [
            isAdmin && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: upcomingReservations.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            lineNumber: 125,
                            columnNumber: 15
                        }, this) : upcomingReservations.map((res)=>{
                            var _rooms_find;
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: [
                                                    "📍 ",
                                                    ((_rooms_find = rooms.find((r)=>r.id === res.roomId)) === null || _rooms_find === void 0 ? void 0 : _rooms_find.name) || res.roomId,
                                                    " — 👤 ",
                                                    res.firstName,
                                                    " ",
                                                    res.lastName
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    selectedRoom && selectedDate && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: HOURS.map((hour)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex flex-col border rounded-xl p-2 transition-all ".concat(isBooked ? 'bg-gray-50 border-gray-100' : 'bg-white border-gray-200 shadow-sm'),
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                disabled: isBooked,
                                                onClick: ()=>setSelectedHour(hour),
                                                className: "p-2 rounded-lg text-sm font-bold text-white transition-all ".concat(isBooked ? "bg-gray-300 cursor-not-allowed" : isSelected ? "bg-green-600 ring-4 ring-green-100" : "bg-blue-600 hover:bg-blue-700"),
                                                children: [
                                                    hour,
                                                    ":30 - ",
                                                    hour + 1,
