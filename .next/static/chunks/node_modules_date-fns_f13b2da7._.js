...
function areIntervalsOverlapping(intervalLeft, intervalRight, options) {
    const [leftStartTime, leftEndTime] = [
        +(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$toDate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDate"])(intervalLeft.start, options === null || options === void 0 ? void 0 : options.in),
        +(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$toDate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDate"])(intervalLeft.end, options === null || options === void 0 ? void 0 : options.in)
    ].sort((a, b)=>a - b);
    const [rightStartTime, rightEndTime] = [
        +(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$toDate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDate"])(intervalRight.start, options === null || options === void 0 ? void 0 : options.in),
        +(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$toDate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDate"])(intervalRight.end, options === null || options === void 0 ? void 0 : options.in)
    ].sort((a, b)=>a - b);
...
function set(date, values, options) {
    let _date = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$toDate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDate"])(date, options === null || options === void 0 ? void 0 : options.in);
    // Check if date is Invalid Date because Date.prototype.setFullYear ignores the value of Invalid Date
    if (isNaN(+_date)) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$constructFrom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["constructFrom"])((options === null || options === void 0 ? void 0 : options.in) || date, NaN);
...
function closestIndexTo(dateToCompare, dates) {
    ...
    const timeToCompare = +(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$toDate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDate"])(dateToCompare);
    if (isNaN(timeToCompare)) return NaN;
    let result;
    let minDistance;
    dates.forEach((date, index)=>{
        const date_ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$toDate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDate"])(date);
        if (isNaN(+date_)) {
            result = NaN;
            minDistance = NaN;
            return;
...
function closestTo(dateToCompare, dates, options) {
    const [dateToCompare_, ...dates_] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$_lib$2f$normalizeDates$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeDates"])(options === null || options === void 0 ? void 0 : options.in, dateToCompare, ...dates);
...
//# sourceMappingURL=node_modules_date-fns_f13b2da7._.js.map