...
function VoyageForm() {
    ...
    async function handleSubmit(e) {
        var _progInput_current_files, _progInput_current, _fileInput_current;
        e.preventDefault();
        setLoading(true);
        setResult(null);
        const form = e.target;
        const formData = new FormData(form);
        const voyageId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$browser$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])();
        const programmeFile = ((_progInput_current = progInput.current) === null || _progInput_current === void 0 ? void 0 : (_progInput_current_files = _progInput_current.files) === null || _progInput_current_files === void 0 ? void 0 : _progInput_current_files[0]) || null;
        const pjFiles = ((_fileInput_current = fileInput.current) === null || _fileInput_current === void 0 ? void 0 : _fileInput_current.files) || [];
        let programme = null;
...
_s(VoyageForm, "m4QaRoMPOOXPAzeZGbuiCoysjR8=", false, function() {
    return [
...
//# sourceMappingURL=_652ff15e._.js.map