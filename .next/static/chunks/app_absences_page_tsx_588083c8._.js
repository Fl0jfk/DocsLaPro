...
"[project]/app/absences/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function AbsenceDeclarationForm() {
    var _user_primaryEmailAddress, _user_emailAddresses_, _user_emailAddresses;
    _s();
    ...
    async function handleSubmit(e) {
        var _user_primaryEmailAddress, _user_emailAddresses_, _user_emailAddresses, _fileInput_current;
        e.preventDefault();
        setLoading(true);
        setResult(null);
        const form = e.target;
        const formData = new FormData(form);
        const prenomClerk = (user === null || user === void 0 ? void 0 : user.firstName) || "";
        const nomClerk = (user === null || user === void 0 ? void 0 : user.lastName) || "";
        const emailClerk = (user === null || user === void 0 ? void 0 : (_user_primaryEmailAddress = user.primaryEmailAddress) === null || _user_primaryEmailAddress === void 0 ? void 0 : _user_primaryEmailAddress.emailAddress) || (user === null || user === void 0 ? void 0 : (_user_emailAddresses = user.emailAddresses) === null || _user_emailAddresses === void 0 ? void 0 : (_user_emailAddresses_ = _user_emailAddresses[0]) === null || _user_emailAddresses_ === void 0 ? void 0 : _user_emailAddresses_.emailAddress) || "";
        formData.set("nom", "".concat(prenomClerk, " ").concat(nomClerk).trim());
        formData.set("email", emailClerk);
        if (((_fileInput_current = fileInput.current) === null || _fileInput_current === void 0 ? void 0 : _fileInput_current.files) && fileInput.current.files.length > 5) {
    ...
    const emailClerk = ((_user_primaryEmailAddress = user.primaryEmailAddress) === null || _user_primaryEmailAddress === void 0 ? void 0 : _user_primaryEmailAddress.emailAddress) || ((_user_emailAddresses = user.emailAddresses) === null || _user_emailAddresses === void 0 ? void 0 : (_user_emailAddresses_ = _user_emailAddresses[0]) === null || _user_emailAddresses_ === void 0 ? void 0 : _user_emailAddresses_.emailAddress) || "";
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                type: "hidden",
                name: "nom",
                value: "".concat(prenomClerk, " ").concat(nomClerk).trim(),
                readOnly: true
            }, void 0, false, {
                fileName: "[project]/app/absences/page.tsx",
                lineNumber: 71,
...
_s(AbsenceDeclarationForm, "wIFsLAmIMMHkFaVu5Pg7b9nDmCg=", false, function() {
    return [
...
_c = AbsenceDeclarationForm;
var _c;
__turbopack_context__.k.register(_c, "AbsenceDeclarationForm");
...
//# sourceMappingURL=app_absences_page_tsx_588083c8._.js.map