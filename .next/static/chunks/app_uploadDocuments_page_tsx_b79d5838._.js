...
"[project]/app/uploadDocuments/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UploadAndAnalyzeDocument() {
    ...
    const [mistralResult, setmistralResult] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [logs, setLogs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const [moveResult, setMoveResult] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const generateFileName = (type, eleve)=>{
        ...
        const timeStr = "".concat(String(now.getHours()).padStart(2, '0')).concat(String(now.getMinutes()).padStart(2, '0')).concat(String(now.getSeconds()).padStart(2, '0'));
        const safeEleve = eleve.replace(/[^a-zA-Z0-9_]/g, '_');
        return "".concat(type, "_").concat(safeEleve, "_").concat(dateStr, "_").concat(timeStr, ".pdf");
    };
    const handleUploadAndAnalyze = async ()=>{
        ...
        let tries = 0;
        do {
            addLog("Polling OCR (tentative ".concat(tries + 1, ")..."));
        ...
        if (text) {
            ...
            if (mistral.eleve && mistral.type) {
                ...
                setStatus("Déplacement du fichier dans le dossier de l’élève ".concat(mistral.eleve, "..."));
                addLog("Appel de /api/move-file avec eleveId : ".concat(eleveId, ", newFileName : ").concat(newFileName));
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            mistralResult && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            moveResult && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(UploadAndAnalyzeDocument, "wMo9xitE2T+5vspVvMN/21HX8oQ=");
_c = UploadAndAnalyzeDocument;
var _c;
__turbopack_context__.k.register(_c, "UploadAndAnalyzeDocument");
...
//# sourceMappingURL=app_uploadDocuments_page_tsx_b79d5838._.js.map