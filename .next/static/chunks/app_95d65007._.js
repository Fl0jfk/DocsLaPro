...
function GoogleAgenda() {
    ...
    const [weekStart, setWeekStart] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Date());
    const [modalEvent, setModalEvent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [draggingEvent, setDraggingEvent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
        ...
        "GoogleAgenda.useEffect": ()=>{
            ...
            async function fetchCalendars() {
                try {
                    ...
                    if ((_data_items = data.items) === null || _data_items === void 0 ? void 0 : _data_items.length) setSelectedCalendar(data.items[0].id);
                } catch (err) {
                    console.error(err);
                }
            }
        ...
        "GoogleAgenda.useEffect": ()=>{
            ...
            async function fetchEvents() {
                try {
                    ...
                    const res = await fetch("https://www.googleapis.com/calendar/v3/calendars/".concat(encodeURIComponent(selectedCalendar), "/events?timeMin=").concat(startISO, "&timeMax=").concat(endISO, "&singleEvents=true&orderBy=startTime"), {
                        headers: {
                            Authorization: "Bearer ".concat(tokens.accessToken)
                        }
                    });
    ...
    async function saveEvent(evt) {
        ...
        const url = evt.id ? "https://www.googleapis.com/calendar/v3/calendars/".concat(encodeURIComponent(selectedCalendar), "/events/").concat(evt.id) : "https://www.googleapis.com/calendar/v3/calendars/".concat(encodeURIComponent(selectedCalendar), "/events");
        try {
    ...
    async function deleteEvent(evtId) {
        if (!tokens || !selectedCalendar) return;
        try {
            await fetch("https://www.googleapis.com/calendar/v3/calendars/".concat(encodeURIComponent(selectedCalendar), "/events/").concat(evtId), {
                method: "DELETE",
                headers: {
                    Authorization: "Bearer ".concat(tokens.accessToken)
                }
    ...
    if (!tokens) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
        href: "/api/google",
        className: "btn",
            ...
            modalEvent && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                            type: "datetime-local",
                            value: (_modalEvent_start_dateTime = modalEvent.start.dateTime) === null || _modalEvent_start_dateTime === void 0 ? void 0 : _modalEvent_start_dateTime.slice(0, 16),
                            onChange: (e)=>setModalEvent({
                                    ...modalEvent,
                                    start: {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                            type: "datetime-local",
                            value: (_modalEvent_end_dateTime = modalEvent.end.dateTime) === null || _modalEvent_end_dateTime === void 0 ? void 0 : _modalEvent_end_dateTime.slice(0, 16),
                            onChange: (e)=>setModalEvent({
                                    ...modalEvent,
                                    end: {
                                        dateTime: e.target.value
...
_s(GoogleAgenda, "vS4T0zHGJY1QD/qldIFmbQL/v/g=", false, function() {
    return [
...
//# sourceMappingURL=app_95d65007._.js.map