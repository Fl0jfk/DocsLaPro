...
"[project]/.next-internal/server/app/api/ecoledirecte/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
async function POST() {
    try {
        const loginRes = await fetch(`${BASE_URL}/login.awp?v=4.75.0`, {
            method: "POST",
            headers: {
        ...
        // Vérifier si un compte est renvoyé
        if (data.token && data.data.accounts && data.data.accounts.length > 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Login réussi !",
                token: data.token,
                accounts: data.data.accounts.map((acc)=>({
                        id: acc.id,
                        typeCompte: acc.typeCompte,
                        identifiant: acc.identifiant,
                        lastConnexion: acc.lastConnexion
                    }))
            });
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e82c18ce._.js.map