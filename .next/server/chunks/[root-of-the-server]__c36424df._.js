...
;
;
const GTK_URL = "https://api.ecoledirecte.com/v3/login.awp?gtk=1&v=4.75.0";
const LOGIN_URL = "https://api.ecoledirecte.com/v3/login.awp?v=4.75.0";
async function POST(req) {
    try {
        ...
        const gtkCookie = gtkRes.headers.get("set-cookie")?.match(/GTK=([^;]+)/)?.[1];
        if (!gtkCookie) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "⚠️ Impossible de récupérer GTK"
            }, {
                status: 500
            });
        }
        const uuid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$node$2f$v4$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])(); // UUIDv4 valide
        const loginPayload = `data=${encodeURIComponent(JSON.stringify({
            identifiant,
            motdepasse,
            isRelogin: false,
            uuid
        }))}`;
        // 3️⃣ Requête POST login
        ...
        if (loginData?.code === 200 && loginData?.token) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "✅ Connexion réussie",
                token: loginData.token,
                accounts: loginData.data?.accounts ?? []
            });
        } else if (loginData?.code === 250) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "⚠️ Double-auth requise",
                details: loginData
            }, {
                status: 401
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c36424df._.js.map