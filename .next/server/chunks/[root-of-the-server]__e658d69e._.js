module.exports = [
"[project]/.next-internal/server/app/api/travels/download/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function getDownloadURL(key) {
    ...
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$s3$2d$request$2d$presigner$2f$dist$2d$es$2f$getSignedUrl$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSignedUrl"])(s3, command, {
        expiresIn: 3600
    });
}
}),
"[project]/app/api/travels/download/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// app/api/travels/download/route.ts
__turbopack_context__.s([
    "GET",
    ()=>GET
]);
...
async function GET(req) {
    ...
    try {
        const url = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$voyageStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDownloadURL"])(key); // génère l'URL présignée pour S3
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(url); // redirige directement le navigateur
    } catch (err) {
        console.error("Erreur téléchargement S3 :", err);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e658d69e._.js.map