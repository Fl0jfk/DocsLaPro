module.exports = [
"[project]/.next-internal/server/app/api/travels/update/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/travels/update/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const { voyageId } = Object.fromEntries(new URL(req.url).searchParams);
        ...
        if (!oldBody) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Voyage introuvable"
        }, {
            status: 404
        });
        const voyage = JSON.parse(oldBody);
        const canEdit = voyage.email === user.primaryEmailAddress?.emailAddress || roles.includes("compta") || roles.includes(voyage.direction_cible);
        if (!canEdit) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Pas la permission de modifier ce voyage"
        }, {
            status: 403
        });
        const updatedVoyage = {
            ...
            pieces_jointes: body.pieces_jointes ?? voyage.pieces_jointes
        };
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Impossible de mettre à jour le voyage"
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd9a48a7._.js.map