...
const ContentSecurityPolicy = `
  ...
  connect-src 'self' https://docslapro.s3.eu-west-3.amazonaws.com https://www.googleapis.com https://clerk-telemetry.com https://*.clerk-telemetry.com https://api.stripe.com https://maps.googleapis.com genuine-wildcat-70.clerk.accounts.dev https://login.microsoftonline.com https://graph.microsoft.com;
