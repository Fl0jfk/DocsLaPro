...
export default function Header() {
    ...
    return (
        <motion.header
            ...
            className={`flex p-4 justify-between items-center w-full sm:fixed md:fixed z-[12] md:mb-[100px] ${opacityMenu} self-center text-2xl overflow-hidden max-w-[1200px] mx-auto bg-[#fff]`}
        >
