...
import { TOOLBOX_ADMIN_LINKS, type ToolboxAdminLinkMeta } from "@/app/lib/toolbox-tools";
...
export default function ToolboxModal({ open, onClose }: Props) {
  ...
  const hasTiles = tools.length > 0 || adminLinks.length > 0;
        ...
        <div className="px-6 pt-6 pb-4 border-b border-slate-100 bg-gradient-to-b from-slate-50 to-white">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Modules, utilitaires et administration</p>
            </div>
            <button
              type="button"
              onClick={onClose}
