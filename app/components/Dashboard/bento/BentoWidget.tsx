...
export default function BentoWidget({
  ...
  return (
    <article
      className={`flex h-full min-h-[8.5rem] flex-col overflow-hidden rounded-2xl border bg-white/92 shadow-sm backdrop-blur-sm transition duration-300 hover:shadow-md ${dash.tileBorder} ${dash.tileBorderHover} ${
