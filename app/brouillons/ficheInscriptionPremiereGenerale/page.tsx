    ...
    return (
        <main className="w-screen max-w-[1000px] flex flex-col mx-auto gap-2 text-sm">
            <div className="bg-pink-400 flex gap-14 p-4 rounded-xl">
                ...
                <div className="flex flex-col text-white uppercase text-[25px] justify-center text-center gap-2">
            ...
            <div className="bg-pink-400  rounded-xl flex flex-col text-white uppercase text-[18px] justify-center text-center p-4">
                <p>Demande d&apos;inscription en première générale et technologique</p>
            </div>
            <section className="border-2 border-pink-400 rounded-xl p-2 px-4 flex flex-col justify-center gap-2 mt-8">
            ...
            <section className="mt-8">
                <div className="border-2 border-pink-400 w-full rounded-xl flex flex-col">
                    <div className="w-full bg-pink-400 flex text-center items-center justify-center rounded-t-lg">     
                        ...
                        <p className=" px-4 py-2 font-bold uppercase w-1/2 text-center">Spécialités (3 obligatoires)</p>
                    </div>
                <div className="w-full flex">
                    ...
                    <div className="align-top text-center">
                        ...
                        <div className="flex gap-4 items-center justify-center p-2">
                                <input type="checkbox"></input>
                                <li className="font-bold uppercase">Section Européenne</li>
                            </div>
                        <hr className="border-pink-400" />
                        <li className="font-bold uppercase p-2 text-[11px]">Enseignements Optionnels (1 au choix ci-dessous)</li>
                            <ul className="list-square">
                                <hr className="border-pink-400" />
                                <ul className="list-square ml-6">
                                <div className="flex justify-between w-[90%] mx-auto p-2">
                    ...
                    <div className="w-1/2">
                        <div className="border-l border-pink-400 align-top text-center">
                            <ul className="list-inside">
                            <ul className="list-square">
                                <div className="flex items-center justify-center w-full p-2">
                                    <div className="flex gap-2 items-center justify-center">
                                        <input type="checkbox"></input>
                                        <li>Histoire-Géographie, Géopol. et Sciences Pol.</li>
                                    </div>
                                </div>
                            </ul>
                            <hr className="border-pink-400" />
                            ...
                            <ul className="list-square">
                                <div className="flex items-center justify-center w-full p-2">
                                    <div className="flex gap-2 items-center justify-center">
                                        <input type="checkbox"></input>
                                        <li>Langues, Littératures et Cultures Etrangères</li>
                                    </div>
                                </div>
                            </ul>
                            <hr className="border-pink-400" />
                ...
                <p className="uppercase font-bold mt-2 text-red-500">Il n&apos;est pas obligatoire de choisir un enseignement optionnel</p>
            </section>
            <section className="border-2 border-pink-400 rounded-xl p-2 px-4 flex flex-col justify-center mt-8 gap-[2px]">
