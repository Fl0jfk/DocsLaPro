                ...
                <div className="w-full flex">
                    ...
                    <div className="w-1/2">
                        <div className="border-l border-pink-400 align-top text-center">
                            <ul className="list-inside">
                            <li className="font-bold uppercase p-2">1 option générale*</li>
                            <hr className="border-pink-400" />
                            ...
                            <hr className="border-pink-400" />
                            <li className="font-bold uppercase p-2">et/ou 1 option technologique</li>
                            <ul className="list-square">
                                ...
                                <div className="flex gap-2 items-center justify-center p-2">
                                    <input type="checkbox"></input>
                                    <li>Sciences et Laboratoires</li>
                                </div>
                                <hr className="border-pink-400" />
                                <div className="flex gap-2 items-center justify-center p-2">
                                    <input type="checkbox"></input>
