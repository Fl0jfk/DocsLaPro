  ...
  return (
    <section className="min-h-screen bg-white text-black font-sans p-8 md:p-16">
      ...
      <div className="grid grid-cols-2 gap-8 max-w-6xl mx-auto py-6">
        <div className="border border-gray-200 px-6 py-4 rounded-2xl bg-zinc-50 hover:bg-white hover:shadow-lg transition-all group">
        ...
        <div className="border border-gray-200 px-6 py-4 rounded-2xl bg-zinc-50 hover:bg-white hover:shadow-lg transition-all">
          <h2 className="text-2xl font-bold text-black mb-6 uppercase tracking-widest">La Découverte</h2>
          <ul className="space-y-4 text-gray-700">
            <li className="flex items-start gap-3">
      ...
      <section className="mt-8 max-w-6xl mx-auto grid grid-cols-3 gap-8 items-end">
        <div className="col-span-2">
          <h2 className="text-3xl font-black mb-8 uppercase tracking-tighter italic text-black">Votre odyssée commence ici</h2>
          <div className="relative ml-4 pl-10 space-y-6">
            <div className="relative">
              <span className="absolute -left-[45px] top-1 w-6 h-6 bg-white border-2 border-red-600 rounded-full flex items-center justify-center">
                  <span className="w-2 h-2 bg-red-600 rounded-full"></span>
              </span>
              <h3 className="font-black text-xl text-black uppercase italic">2026 : L'Éveil Culturel</h3>
              <p className="text-sm text-gray-500 mt-1 uppercase tracking-tight font-semibold">Club Cinéma • Arts Martiaux • Gastronomie</p>
            </div>
            <div className="relative">
              <span className="absolute -left-[45px] top-1 w-6 h-6 bg-white border-2 border-gray-400 rounded-full flex items-center justify-center">
                  <span className="w-2 h-2 bg-gray-400 rounded-full"></span>
              </span>
              <h3 className="font-black text-xl text-black uppercase italic">Hiver 2026 : Le Partage</h3>
              <p className="text-sm text-gray-500 mt-1 uppercase tracking-tight font-semibold italic text-red-500">Collecte Trousse à Projets & Marché asiatique</p>
            </div>
            <div className="relative">
              <span className="absolute -left-[45px] top-1 w-6 h-6 bg-red-600 shadow-[0_0_10px_rgba(220,38,38,0.3)] rounded-full"></span>
              <h3 className="font-black text-2xl text-red-600 uppercase italic">Avril 2027 : L'Apothéose</h3>
              <p className="text-black text-lg font-semibold mt-1 uppercase tracking-tighter">Décollage pour Tokyo</p>
            </div>
          </div>
        </div>
      ...
      <footer className="mt-8 border-t border-gray-100 text-center pt-8">
        <p className="text-gray-400 text-[10px] uppercase tracking-[0.5em]">La Providence Nicolas Barré • Projet Japon • Avril 2027</p>
      </footer>
    </section>
  );
}