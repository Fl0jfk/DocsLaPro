...
export const ORGANIGRAM_DIRECTORS: OrganigramPerson[] = [
  {
    ...
    photoUrl: "https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/Plantec-Elise-1.png",
  ...
  },
  {
    ...
    photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/Direction_5-removebg-preview.png",
  ...
  },
  {
    ...
    photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/mme-dona-directrice-lycee-la-providence-nicolas-barre-mesnil-esnard.png",
  ...
  people: [
    {
      ...
      firstName: "Pauline",
      lastName: "LEBLOND",
      photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/LEBLOND+Pauline.jpg",
    ...
    },
    {
      ...
      firstName: "Sarah",
      lastName: "VILLIER",
      photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/BUNO+SARAH.jpg",
    ...
    },
    {
      ...
      photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/FHM.jpeg",
...
export const ORGANIGRAM_ACCOUNTING: OrganigramBlock = {
  ...
  people: [
    ...
    },
    {
      ...
      firstName: "Anaïs",
      lastName: "BOUTIGNY",
      photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/BOUTIGNY+Ana%C3%AFs.jpg",
      role: "Comptable",
    ...
    },
    {
      ...
      firstName: "Cécile",
      lastName: "DOUAGLIN",
      photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/CECILE+DOUAGLIN.jpg",
      role: "Comptable",
  ...
  people: [
    {
      ...
      firstName: "Karine",
      lastName: "PERRIER",
      photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/PERRIER+Karine.jpg",
  ...
  people: [
    {
      ...
      firstName: "Ludmila",
      lastName: "BERBRA",
      photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/Ludmila+BERBRA.jpeg",
    ...
    },
    {
      ...
      firstName: "Thomas",
      lastName: "PEREZ",
      photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/Thomas+PEREZ.jpg",
  ...
  people: [
    {
      ...
      firstName: "Jérôme",
      lastName: "LAINE",
      photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/LAINE+JEROME.jpg",
    ...
    blocks: [
      {
        ...
        people: [
          { id: "cfe-col-1", 
            firstName: "Gaëlle",
            lastName: "CORIOU",
            photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/CORIOU+Gaelle.jpg",
            role: "CPE 6EME/5EME", 
          ...
          { id: "cfe-col-3", 
            firstName: "Lise",
            lastName: "HAMEL",
            photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/HAMEL+LISE.jpg",
            role: "CPE transverse - Responsables des surveillants", 
            missions: ["À compléter. "] },
          { id: "vs-col-assist", 
            firstName: "Constance",
            lastName: "VIERA DA ROSA",
            photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/VIEIRA+DA+ROSA+Constance.jpg",
        ...
        people: [
          {
            ...
            firstName: "Isabelle",
            lastName: "CONSTANT",
            photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/I.+CONSTANT.jpg",
            role: "CPE lycée",
          ...
          },
          {
            ...
            firstName: "Karim",
            lastName: "YAICI",
            photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/YAICI+Karim.jpg",
...
export const ORGANIGRAM_PASTORAL: OrganigramBlock = {
  ...
  people: [
    { id: "past-1", 
      firstName: "Céline",
      lastName: "DUBOC",
      photoUrl:"https://docslaproimage.s3.eu-west-3.amazonaws.com/organigram/DUBOC+CELINE.jpg",
