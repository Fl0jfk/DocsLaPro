...
export default function AbsenceDeclarationForm() {
  ...
  return (
    <form onSubmit={handleSubmit} encType="multipart/form-data" className="pt-[20vh] flex flex-col items-center gap-4">
      ...
      <label>
        Prénom&nbsp;: 
        <input type="text" name="prenom_display" value={prenomClerk} readOnly tabIndex={-1} style={{ background: "#f5f5f5" }} />
      </label>
      <label>
        Nom&nbsp;: 
        <input type="text" name="nom_display" value={nomClerk} readOnly tabIndex={-1} style={{ background: "#f5f5f5" }} />
      </label>
      <label>
        Email&nbsp;: 
        <input type="email" name="email_display" value={emailClerk} readOnly tabIndex={-1} style={{ background: "#f5f5f5" }} />
      </label>
