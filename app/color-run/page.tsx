  ...
  if (sent)
    return (
        <>
            ...
            <button type="submit"  disabled={loading} className="bg-blue-500 text-white py-2 rounded-xl hover:bg-blue-600 disabled:opacity-50">{loading ? 'Envoi en cours...' : 'Envoyer'}</button>
            </form>
        </>
        )
  return (
