    ...
    return (
        <main className="w-screen max-w-[1000px] flex flex-col mx-auto gap-1 text-sm">
            ...
            <div className="bg-blue-400  rounded-xl flex flex-col text-white uppercase text-[18px] justify-center text-center p-4">
                <p>Demande d&apos;inscription en quatrième</p>
            </div>
            ...
            <section className="border-2 border-blue-400 rounded-xl p-2 px-4 flex flex-col justify-center">
                <h3 className="text-center underline font-bold text-xl mt-[-6px]">Régime</h3>
            ...
            <section>
                <div className="border-2 border-blue-400 w-full rounded-t-xl flex flex-col">
                    <div className="w-full bg-blue-400 flex text-center items-center justify-center rounded-t-lg">     
                        <p className="px-4 py-2 font-bold uppercase w-[100%] text-center">Souhait concernant la classe de 4ème</p>
                    </div>
                <div className="w-full flex">
                    ...
                    <div className="align-top text-center">
                        <ul className="list-inside">
                            <div className="flex gap-2 items-center justify-center p-2">
                                <input type="checkbox"></input>
                                <li>4ème Anglais LV1 + Espagnol LV2</li>
                            </div>
                        <hr className="border-blue-400" />
                        <div className="flex gap-2 items-center justify-center p-2">
                                <input type="checkbox"></input>
                                <li>4ème Bilangue (Anglais + Allemand LV1)</li>
                        </div>
                    ...
                    <div className="align-top text-center">
                        <ul className="list-inside">
                            <div className="flex gap-2 items-center justify-center p-2">
                                <input type="checkbox"></input>
                                <li>4ème Anglais LV1 + Allemand LV2</li>
                            </div>
                        <hr className="border-blue-400" />                  
                        </ul>
                        <ul className="list-inside">
                            <div className="flex gap-2 items-center justify-center p-2">
                                <input type="checkbox"></input>
                                <li>4ème avec accompagnement pour les élèves à besoin particulier</li>
                            </div>                 
                        </ul>
                    </div>
                    </div>
                ...
                <div className="border-2 border-blue-400 w-full rounded-b-xl flex flex-col">
                    <div className="w-full bg-blue-400 flex text-center items-center justify-center">     
                        <p className="px-4 py-2 font-bold uppercase w-[100%] text-center">Enseignements optionnels</p>
                    </div>
                <div className="w-full flex">
                    <div className="w-[40%] border-r border-blue-400">
                    <div className="align-top text-center">
            ...
            <section className="border-2 border-blue-400 rounded-xl p-2 px-4 flex flex-col justify-center gap-[2px]">
                <h3 className="text-center underline font-bold text-xl leading-5 mt-[-4px]">Autres informations</h3>
