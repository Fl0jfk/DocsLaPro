    ...
    return (
        <main className="w-screen max-w-[1000px] flex flex-col mx-auto gap-2 text-sm">
            ...
            <div className="bg-pink-400 rounded-xl flex flex-col text-white uppercase text-[18px] justify-center text-center p-4">
                <p>Demande d&apos;inscription en terminale générale et technologique</p>
            </div>
            <section className="border-2 border-pink-400 rounded-xl p-2 px-4 flex flex-col justify-center gap-2 mt-1">
            ...
            <section className="mt-1">
                ...
                <div className="w-full flex">
                    ...
                    <div className="align-top text-center">
                        ...
                        <hr className="border-pink-400" />
                        <li className="font-bold uppercase p-2">Enseignements Optionnels (2 choix ou 3 si Latin ou Grec, ci-dessous)</li>
                    ...
                    <div className="w-1/2">
                        <div className="border-pink-400 align-top text-center">
                            <ul className="list-inside">
                            <ul className="list-square">
